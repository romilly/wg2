...
class EndToEndTestCase(unittest.TestCase):
    ...
    # TODO: replace tests/generated by self.target_directory
    def test_images_are_included(self):
        assert_that('tests/generated/about.html', file_content(string_contains_in_order('<img alt="Romilly Cocking" src="img/romilly.jpg" />')))
